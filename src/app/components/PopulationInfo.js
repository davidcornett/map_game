    ...
    return (
        <div className="max-w-lg mx-auto my-8 p-6 bg-customVeryDark rounded-lg shadow-md">
            ...
            <div className="p-4 flex justify-between items-center">
                <div>
                <div className="uppercase tracking-wide text-sm text-white font-semibold">Total Population: {newCountryStats.total_population.toLocaleString()}</div>
                </div>
            </div>
            </div>
            ...
            <div className="max-w-md w-full mx-auto bg-customDark rounded-xl shadow-md overflow-hidden mb-4 md:w-full lg:max-w-md">
                <div className="p-4 flex justify-between items-center">
                    <div>
                    <div className="uppercase tracking-wide text-sm text-white font-semibold">Global Population Ranking</div>
                    </div>
                    <button 
            ...
            <div className="p-4 flex justify-between items-center">
                <div>
                <div className="uppercase tracking-wide text-sm text-white font-semibold">Demographic Breakdown</div>
                </div>
                <button 
